  ...
  <header>
        <div class="topbar navbar-fixed-top">
          <div class="container">
            <div class="row">
              <div class="col-md-12">      
                <p class="pull-left hidden-xs"><i class="fa fa-phone"></i>Tel No. +254799041089</p>
    ...
    <div class="row">
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          Meru-Maua road<br>
           Nchiru Kenya.</address>
          <p>
            <i class="icon-phone"></i> (254) 113243665 <br>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="copyright">
            <p>
              <span>&copy; CyberExperts 2022 All right reserved.  
            </p>
          </div>
        </div>
        <div class="col-lg-6">
